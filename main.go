...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "小伞","多多良小伞","多々良　小傘","たたら　こがさ", "Set default nickname.")
	...
	// 通过代码写死的方式添加主人账号
	// sus = append(sus, 1779941717)
	// sus = append(sus, 1605156223)
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "小伞","多多良小伞","多々良　小傘","たたら　こがさ"),
